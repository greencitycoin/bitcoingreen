...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Green City Core"),
     ...
     * override -datadir in the greencity.conf file in the default data directory
     * (to be consistent with greencityd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
