...
/** Utility functions used by the GreenCity Qt UI.
 */
namespace GUIUtil
{
...
// Render GCC addresses in monospace font
...
// Parse "greencity:" URI into recipient object, return true on successful parsing
