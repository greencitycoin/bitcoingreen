...
/* Green City GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GreenCity"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "GreenCity-Qt"
#define QAPP_APP_NAME_TESTNET "GreenCity-Qt-testnet"
