...
#if defined(NDEBUG)
#error "Green City cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ugcc) are considered zero fee (for relaying and mining)
...
{
    RenameThread("greencity-scriptch");
