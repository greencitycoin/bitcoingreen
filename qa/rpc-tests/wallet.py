...
#   c) node1 mines 32 blocks, so now node 0 has 500000GCC, node 1 has 4250GCC, node2 has none.
#   d) node0 sends 601 GCC to node2, in two transactions (301 GCC, then 300 GCC).
