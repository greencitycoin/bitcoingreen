...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/greencity-cli.cpp \
           src/greencity-tx.cpp \
           src/greencity.cpp \
           src/db.cpp \
           ...
           src/qt/greencity.cpp \
           src/qt/greencitystrings.cpp \
...
RESOURCES += src/qt/greencity.qrc src/qt/greencity_locale.qrc

TRANSLATIONS += src/qt/locale/greencity_bg.ts \
                src/qt/locale/greencity_de.ts \
                src/qt/locale/greencity_en.ts \
                src/qt/locale/greencity_es.ts \
                src/qt/locale/greencity_fi.ts \
                src/qt/locale/greencity_fr.ts \
                src/qt/locale/greencity_it.ts \
                src/qt/locale/greencity_ja.ts \
                src/qt/locale/greencity_pl.ts \
                src/qt/locale/greencity_pt.ts \
                src/qt/locale/greencity_ru.ts \
                src/qt/locale/greencity_sk.ts \
                src/qt/locale/greencity_sv.ts \
                src/qt/locale/greencity_vi.ts \
                src/qt/locale/greencity_zh_CN.ts \
                src/qt/locale/greencity_zh_TW.ts
