Contributing to Green City Core
==================================

The Green City Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Green City Core project, and is not to be
confused with overall Green City Network Protocol consensus changes.

Whether a pull request is merged into Green City Core rests with the project merge
...
Patches that change Green City consensus rules are considerably more involved than
...
Where a patch set proposes to change the Green City consensus, it must have been
...
The project leader is the release manager for each Green City Core release.
