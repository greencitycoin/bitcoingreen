...
Green City now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<greencity_address\> \<monthly_payment_greencity\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GCC, _12_ times over the course of a year totaling _24000_ GCC.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<greencity_address\> \<monthly_payment_greencity\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` GCC.
 ...
 * vote-many          - Vote on a Green City initiative
 * vote-alias         - Vote on a Green City initiative
 * vote               - Vote on a Green City initiative/budget
