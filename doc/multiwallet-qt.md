...
In order to support loading of multiple wallets in greencity-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is greencity.cpp.
...
Changes to greencity.cpp
----------------------
greencity.cpp is the entry point into greencity-qt, and as such, will require some minor modifications to provide hooks for
