...
Intro
-----
Green City (GCC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Green City utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run greencity-qt.exe.

Green City Core is the original Green City client and it builds the backbone of the network.
However, it downloads and stores the entire history of Green City transactions;
